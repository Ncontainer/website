...
const GetStarted = () => {
    return (
      <section className="w-full relative overflow-hidden">
        ...
        </div>        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="flex flex-col md:flex-row items-center py-12 md:py-16">            {/* Left text content */}
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-end overflow-hidden">
              <div className="relative w-full md:w-auto">
                {/* Container image */}
                <div className="transform scale-[1.3] sm:scale-[1.5] md:scale-[1.6] lg:scale-[1.8] xl:scale-[2.2] translate-y-4 md:translate-y-0 md:translate-x-8 lg:translate-x-12">
                  <img 
                    src={img} 
