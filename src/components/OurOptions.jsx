  ...
  return (
    <div className="pb-8 lg:py-12">
      <div className="w-full px-4 sm:px-6 lg:px-8" style={{ width: '85%', margin: '0 auto' }}>
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-gray-900 text-center mt-4 sm:mt-0 mb-8">
          Our Options
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full" style={{ backgroundColor: 'rgba(255, 137, 1, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem' }}>
              <svg className="w-6 h-6" fill="none" stroke={orangeColor} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 9l3-3m0 6l-3-3m7 11a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            ...
            <div className="flex gap-2">
              <button
                onClick={() => handleRedirect('/one-way')}
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full" style={{ backgroundColor: 'rgba(255, 137, 1, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem' }}>
              <svg className="w-6 h-6" fill="none" stroke={orangeColor} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2-2H9m2-2h2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
