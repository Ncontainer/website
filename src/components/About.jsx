    ...
    <>
      <section className="w-full">
        ...
        <div className="w-[94%] m-auto flex flex-col sm:flex-row justify-between gap-6 px-4 sm:px-6 md:px-10 lg:px-16 py-8 sm:py-10 bg-white text-black">
          ...
          >
            At NCON, we do not just move containers — we move businesses
            forward. In an industry crowded with one-size-fits-all players, we
            stand apart by offering container solutions designed for safety,
            speed, sustainability, and trust.
            <br />
            <br />
            From secure storage facilities to hassle-free rentals, and from
            buying and selling containers to custom logistics support, we bring
            more than just boxes on wheels — we bring reliability, transparency,
            and efficiency that redefine what container logistics should mean.
            <br />
            <br />
            <div className="font-bold">Our Edge Over Competitors</div>
            At NCON, containers are not commodities — they are strategic assets.
            With a tech-driven approach and personalized service, we deliver
            solutions that unlock value, cut costs, and future-proof logistics.
            We are not just another provider; we are partners in innovation,
        ...
        {/* Our Vision Section */}
        <div
          className="relative w-[94%] sm:w-[90%] lg:w-[88%] mx-auto py-10 px-6 sm:px-10 rounded-md text-white bg-[#f7921e] overflow-hidden"
          style={{
        ...
        >
          <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-6 rounded-md">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white">
              We envision a future where logistics is not just about moving
              containers, but about moving with purpose. By blending technology,
              sustainability, and trust, NCON strives to be the most reliable
              partner in containerized solutions — making logistics faster,
              safer, and smarter for businesses worldwide.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-[94%] sm:w-[92%] lg:w-[90%] mx-auto flex flex-col gap-10 px-4 py-12">
        {/* Our Mission */}
        <div
          className="relative rounded-md text-white bg-[#1E1E1E] overflow-hidden p-6 sm:p-10"
          style={{
        ...
        {/* Our Values */}
        <div
          className="relative rounded-md text-white bg-[#ff9215] overflow-hidden p-6 sm:p-10"
          style={{
