...
const LogisticsOverview = () => {
  ...
  return (
    <section className="w-full mt-12 bg-white" id="logistics-overview">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center space-y-6 order-1 md:order-2">
            ...
            <div>
              <button
                ...
                className="px-6 py-2 mt-2 sm:mt-4 border border-black rounded-full hover:bg-black hover:text-white transition-colors"
              >
                Learn More
              </button>
            </div>
