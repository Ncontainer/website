...
export default function Header() {
  ...
  useEffect(() => {
    const handleRouteChange = () => {
      ...
      else if (path === "/brochure") setActiveItem("brochure"); // New active item for brochure
      else if (path === "/login") setActiveItem("login"); // New active item for login
    };
  ...
  return (
    <header className={`bg-white shadow-sm w-full content-center fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "scrolled-header" : ""}`}>
