...
import tm09 from "../images/kishoregopal.webp";
...
const OurTeam = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      id: 3,
      name: "Shruti Parab",
      position: "Business Development Manager (West Zone)",
          ...
          {teamMembers.map((member, index) => (
            <div
              ...
              className={` cursor-pointer transition-all duration-300 ${
                index === currentIndex
                  ? "ring-2 rounded-lg ring-orange-500 scale-105"
                  : "hover:scale-105"
              }`}
