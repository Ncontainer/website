...
export default function RegistrationPage() {
    ...
    const handleChange = (e) => {
      ...
      switch (placeholder) {
        ...
        default: fieldName = placeholder; // Fallback for other inputs if you add more
      }
  
      // This is generally correct for handling select elements where name attribute matches state key
    ...
    const handleContinue = (e) => {
      ...
      // Ensure that formData[field] is not undefined before calling .trim()
      const allFilled = required.every(field => formData[field] && formData[field].trim() !== '');
  
      if (allFilled) {
        navigate('/requirement'); // This route will need to be defined in App.jsx as well
      } else {
        ...
        <div className="bg-white relative flex flex-col items-center px-12 pt-8 pb-20 overflow-y-auto">
          ...
          <div className="w-full">
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="grid grid-cols-2 gap-4 w-full">
                <select
                  name="country" // Make sure name attribute matches the formData key
                ...
                <select
                  name="state" // Make sure name attribute matches the formData key
                  className="w-full p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white"
